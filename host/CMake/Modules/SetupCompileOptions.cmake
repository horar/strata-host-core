...
set(CMAKE_C_FLAGS_OTA "${CMAKE_CXX_FLAGS_RELEASE}" CACHE STRING
    "Flags used by the C compiler during OTA builds." FORCE
)
set(CMAKE_EXE_LINKER_FLAGS_OTA "${CMAKE_CXX_FLAGS_RELEASE}" CACHE STRING
    "Flags used for linking binaries during OTA builds." FORCE
)
set(CMAKE_SHARED_LINKER_FLAGS_OTA "${CMAKE_CXX_FLAGS_RELEASE}" CACHE STRING
