...
function Component()
{
    ...
    */
    ...
    // LC start - show only platform relevant packages
    installer.componentByName("tech.spyglass.strata.hcs2.osx").setValue("Virtual", "true");
    installer.componentByName("tech.spyglass.strata.hcs2.windows").setValue("Virtual", "true");

    if ( systemInfo.productType === "osx") {
        installer.componentByName("tech.spyglass.strata.hcs2.osx").setValue("Virtual", "false");
        //installer.componentByName("tech.spyglass.strata.hcs2.osx").setValue("ForcedInstallation", "true");
        // QTIFW-675
        installer.componentByName("tech.spyglass.strata.hcs2.osx").setValue("Default", "true");
        installer.componentByName("tech.spyglass.strata.hcs2.osx").enabled = false;
    }
    if ( systemInfo.productType === "windows") {
        installer.componentByName("tech.spyglass.strata.hcs2.windows").setValue("Virtual", "false");
        //installer.componentByName("tech.spyglass.strata.hcs2.windows").setValue("ForcedInstallation", "true");
        // QTIFW-675
        installer.componentByName("tech.spyglass.strata.hcs2.windows").setValue("Default", "true");
        installer.componentByName("tech.spyglass.strata.hcs2.windows").enabled = false;
    }
    // LC end
