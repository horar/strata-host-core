...
Item {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            property bool comingSoon: !model.available.documents && !model.available.order && !model.error && (!model.connected || !model.available.control)
            ...
            ColumnLayout {
                ...
                PlatformControlButton {
                    ...
                    toolTipText: buttonEnabled ? "" : "Hardware not connected or not recognized"
