...
Rectangle {
    ...
    GridLayout {
        ...
        SGIcon {
            source: requirementsGrid.passwordsMatch ? "qrc:/sgimages/check-circle-solid.svg" : "qrc:/sgimages/times-circle-solid.svg"
        ...
        SGIcon {
            source: requirementsGrid.hasCapital ? "qrc:/sgimages/check-circle-solid.svg" : "qrc:/sgimages/times-circle-solid.svg"
        ...
        SGIcon {
            source: requirementsGrid.hasLower ? "qrc:/sgimages/check-circle-solid.svg" : "qrc:/sgimages/times-circle-solid.svg"
        ...
        SGIcon {
            source: requirementsGrid.hasNumber ? "qrc:/sgimages/check-circle-solid.svg" : "qrc:/sgimages/times-circle-solid.svg"
        ...
        SGIcon {
            source: requirementsGrid.lengthValid ? "qrc:/sgimages/check-circle-solid.svg" : "qrc:/sgimages/times-circle-solid.svg"
