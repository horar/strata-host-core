...
QString DebugMenuGenerator::generateHelperFunctions()
{
    ...
    text += writeLine("} else if (payloadProp.type === \"bool\") {");
    indentLevel++;
    text += writeLine("outputArr.push((payloadProp.value === \"true\"))");
    indentLevel--;
    text += writeLine("} else if (payloadProp.type === \"int\") {");
    indentLevel++;
    text += writeLine("outputArr.push(parseInt(payloadProp.value))");
    indentLevel--;
    text += writeLine("} else if (payloadProp.type === \"double\") {");
    indentLevel++;
    text += writeLine("outputArr.push(parseFloat(payloadProp.value))");
    indentLevel--;
    text += writeLine("} else {");
    indentLevel++;
    text += writeLine("outputArr.push(payloadProp.value)");
    indentLevel--;
    text += writeLine("}");
    indentLevel--;
    text += writeLine("}");
    ...
    text += writeLine("} else if (payloadProp.type === \"bool\") {");
    indentLevel++;
    text += writeLine("outputObj[objectProperty.key] = (payloadProp.value === \"true\")");
    indentLevel--;
    text += writeLine("} else if (payloadProp.type === \"int\") {");
    indentLevel++;
    text += writeLine("outputObj[objectProperty.key] = parseInt(payloadProp.value)");
    indentLevel--;
    text += writeLine("} else if (payloadProp.type === \"double\") {");
    indentLevel++;
    text += writeLine("outputObj[objectProperty.key] = parseFloat(payloadProp.value)");
    indentLevel--;
    text += writeLine("} else {");
    indentLevel++;
    text += writeLine("outputObj[objectProperty.key] = payloadProp.value");
    indentLevel--;
    text += writeLine("}");
    indentLevel--;
    text += writeLine("}");
