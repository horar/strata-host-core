...
void HostControllerService::parseHCSCommands(const string& hcs_message)
{
    ...
    // disconnect a particular user
        ...
        for (uint32_t i = 0; i < array.Size(); i++) {
            ...
            // be waiting for this function to return and this function may take more time (slow
            // internet, large file,..) JIRA SCT-289 has been created to take care of this issue
