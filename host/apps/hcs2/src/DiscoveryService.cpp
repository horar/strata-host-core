...
{
    service_connector_ = ConnectorFactory::getConnector(ConnectorFactory::CONNECTOR_TYPE::REQUEST);
...
std::string DiscoveryService::buildPlatformJson()
{
    ...
    array_object.AddMember("verbose", PLATFORM_VERBOSE_NAME,
                           allocator);  // add platform verbose name
