...
public:
    ...
    bool condensedInScrollback() const;
    void setCondensedInScrollback(bool condensedInScrollback);
...
signals:
    ...
    void condensedInScrollbackChanged();
...
private:
    ...
    bool condensedInScrollback_ = false;
