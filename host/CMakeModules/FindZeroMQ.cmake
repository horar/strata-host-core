...
if(WIN32)
  find_library( ZEROMQ_LIBRARIES NAMES "libzmq" PATHS ${EXT_LIBS_PATH}/libzmq/lib/${PLATFORM_TYPE} )
else()
  find_library( ZEROMQ_LIBRARIES NAMES "zmq" PATHS ${EXT_LIBS_PATH}/libzmq/lib/${PLATFORM_TYPE} )
endif()
find_path( ZEROMQ_INCLUDE_DIR "zmq.h" PATHS ${EXT_LIBS_PATH}/libzmq/include NO_DEFAULT_PATH)
