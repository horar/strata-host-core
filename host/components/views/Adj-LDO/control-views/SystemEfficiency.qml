...
Item {
    ...
    Component.onCompleted: {
        ...
        Help.registerTarget(pgldoLabel, "This indicator will be green when the LDO power good signal is high. If the TSOP-5 LDO package is being used, the indicator will be green when the PG_308 signal from the NCP308 used to monitor the LDO output voltage is high.", 24, "AdjLDOSystemEfficiencyHelp")
    }
