...
", 9, "samoptHelp")
        ...
        Help.registerTarget(filterHelpContainer2, "Set a new 7-bit I2C slave address. Click Apply I2C Address to change. The value entered will be coerced to a valid I2C slave address between 0x60 and 0x7F. The Current 7-bit I2C Address will be updated with the new address if successfully applied. This design will by default search for a device with I2C CRC disabled and 7-bit I2C slave address of 0x60 \nif no LED driver is found the user must enter a valid I2C configuration to enable the user interface.
", 2, "samoptHelp")
