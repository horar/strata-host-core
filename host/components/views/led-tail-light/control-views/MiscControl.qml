...
Item {
    ...
    Component.onCompleted: {
        ...
        Help.registerTarget(filterHelpContainer1, "Indicates an error with the external NCV47822 load switches being shorted to ground or over current event.", 2, "miscHelp")
    }
