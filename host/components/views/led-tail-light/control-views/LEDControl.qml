...
Item {
    ...
    Component.onCompleted: {
        ...
        Help.registerTarget(gobalCurrentSetSlider,"Sets the maximum current for each individual LED channel.",2,"ledDriverHelp")
        ...
        Help.registerTarget(scIset,"Set when the ISET pin is short-circuited to ground.",15,"ledDriverHelp")    
