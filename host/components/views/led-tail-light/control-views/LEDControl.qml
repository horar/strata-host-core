...
Item {
    ...
    Component.onCompleted: {
        Help.registerTarget(partNumber, "Indication of LED driver part assembled on PCB. The part number is reported to the user interface based on state of pin PD9, low = NCV7684, high = NCV7685. The other LED driver can be installed if the state of the PD9 pin properly reflects the installed LED driver.", 0, "ledDriverHelp")
        ...
        Help.registerTarget(gobalCurrentSetSlider,"Sets the maximum current for all LED channels.",2,"ledDriverHelp")
        ...
        Help.registerTarget(lockPWMDutyEN,"Locks together the PWM enable or disable state for all LED channels. Use OUT0 PWM Enable switch to control all channels when locked together.",4,"ledDriverHelp")
        Help.registerTarget(lockPWMDuty,"Locks together the PWM duty cycle for all LED channels. Use OUT0 PWM Duty slider to control all channels when locked together. The duty cycles are always locked together for the NCV7684 because it only has one duty cycle for all channels.",5,"ledDriverHelp")
        ...
        Help.registerTarget(diag,"Generic diagnostic error when any LED channel is in an error mode.",13,"ledDriverHelp")
        ...
        Help.registerTarget(scIset,"Set when the ISET pin is short-circuited to ground after 10µs and resets 10µs after short is removed.",15,"ledDriverHelp")    
