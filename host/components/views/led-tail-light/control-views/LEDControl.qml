...
Item {
    ...
    Component.onCompleted: {
        ...
        Help.registerTarget(tw,"Thermal warning that is set when junction temperature is above the Tjwar_on threshold (140Â°C typical) and reset on register read and when temperature is below Tjwar_on minus Tjsd_hys threshold (127.5Â°C typical).",19,"ledDriverHelp")
        Help.registerTarget(tsd,"Thermal shutdown set when junction temperature is above the TSD threshold (170Â°C typical) and reset on register read and when temperature is below TSD minus Tjsd_hys threshold (157.5Â°C typical).",20,"ledDriverHelp")
