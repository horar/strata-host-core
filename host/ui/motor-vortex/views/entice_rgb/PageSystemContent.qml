        ...
        Rectangle{
            ...
            ColumnLayout{
                ...
                Image{
                    ...
                    source:"./images/system_content/DC-DCPowerIcon.png"
                }
                Button{
                    id:button1
                    checkable: true
                    ...
                    onClicked: {
                        ...
                        currentSchematic = "./images/system_content/PowerStageSchematic.png"
                        currentBlockDiagram = "./images/system_content/USB-PD_blockDiagram_PowerStage1Highlighted.png"
                ...
                Button{
                    ...
                    onClicked: {
                        currentSystemModel = powerStagesModel
                        currentSchematic = "./images/system_content/PowerStageSchematic.png"
                        currentBlockDiagram = "./images/system_content/USB-PD_blockDiagram_PowerStage2Highlighted.png"
                        //currentVPModel = vpModel2
                    }
                }
                Button{
                    ...
                    onClicked: {
                        ...
                        currentSchematic = "./images/system_content/ThreeVoltRailSchematic.png"
                        currentBlockDiagram = "./images/system_content//USB-PD_blockDiagram_ThreeVoltHighlighted.png"
                        //currentVPModel = vpModel2
                    }
                }
            }
        ...
        Rectangle{
            ...
            ColumnLayout{
                ...
                Image{
                    ...
                    fillMode: Image.PreserveAspectFit
                    source:"./images/system_content/ProtectionIcon.png"
                }
                Button{
                    id:button4
                    checkable: true
                    ...
                    onClicked: {
                        ...
                        currentSchematic = "./images/system_content/BatteryProtectionSchematic.png"
                        currentBlockDiagram = "./images/system_content//USB-PD_blockDiagram_BatteryProtectionHighlighted.png"
        ...
        Rectangle{
            ...
            ColumnLayout{
                ...
                Image{
                    ...
                    Layout.bottomMargin: 6
                    fillMode: Image.PreserveAspectFit
                    source:"./images/system_content/SensorsIcon.png"
                }
                Button{
                    id:button5
                    checkable: true
                    ...
                    onClicked: {
                        ...
                        currentSchematic = "./images/system_content//TempSensorSchematic.png"
                        currentBlockDiagram = "./images/system_content/USB-PD_blockDiagram_TempSensorHighlighted.png"
                        //currentVPModel = vpModel2
                    }
                }
                Button{
        ...
        Rectangle{
            ...
            ColumnLayout{
                ...
                Image{
                    ...
                    fillMode: Image.PreserveAspectFit
                    source:"./images/system_content//USBInterfaceIcon.png"
                }
                Button{
                    id:button7
                    checkable: true
                    ...
                    onClicked: {
                        ...
                        currentSchematic = "./images/system_content/USBCInterfaceSchematic1.png"
                        currentBlockDiagram = "./images/system_content/USB-PD_blockDiagram_USB-C1Highlighted.png"
                        //currentVPModel = vpModel2
                    }
                }
                Button{
                    ...
                    onClicked: {
                        currentSystemModel = usbCModel
                        currentSchematic = "./images/system_content/USBCInterfaceSchematic1.png"
                        currentBlockDiagram = "./images/system_content/USB-PD_blockDiagram_USB-C2Highlighted.png"
                        //currentVPModel = vpModel2
                    }
                }
            ...
            delegate: Item {
                ...
                Rectangle{
                    ...
                    Popup {
                        ...
                        width: parent.contentItem.width * 0.75; height: parent.contentItem.height * 0.65
                        modal: true
                        focus: true

                        topMargin: parent.contentItem.height/4
                        bottomMargin: parent.contentItem.height/4
                        leftMargin: parent.contentItem.width/4
                        rightMargin: parent.contentItem.width/4

                        closePolicy: Popup.CloseOnEscape | Popup.CloseOnPressOutsideParent
                        background: Image {
                            id: popupBorder
                            source: "./images/system_content/dialogBorder.svg"
                        ...
                        contentItem: Rectangle{
                            ...
                            Image {
                                anchors.fill: parent
                                fillMode: Image.PreserveAspectFit
                                source: "./images/system_content/NCV81599_test_report.png";
                            }
                        }
                    }
        ...
        Rectangle{
            ...
            Image {
                ...
                Rectangle{
                    ...
                    Popup {
                        id: schematicPopup
                        width: parent.contentItem.width * 0.65
                        height: parent.contentItem.height * 0.65
                        modal: true
                        focus: true
                        ...
                        contentItem: Rectangle{
                            ...
                            Image {
                                ...
                                anchors.fill: parent
                                fillMode: Image.PreserveAspectFit
                                source: "./images/system_content/ONSEC-17-014_schematic.png";
                            }
