...
void StrataServerTest::testServerFunctionality()
{
    ...
    server.registerHandler("register_client",
                           [&server](const strata::strataComm::Message &message) {
    ...
    connect(
        &client, &strata::strataComm::ClientConnector::newMessageRecived, this,
    ...
    connect(&client_2, &strata::strataComm::ClientConnector::newMessageRecived, this,
...
void StrataServerTest::testBuildErrorApiV2()
{
    ...
    server.registerHandler("test_error", [&server](const strata::strataComm::Message &message) {
        server.notifyClient(message, {{"key", "value"}, {"test", "test"}},
                            strata::strataComm::ResponseType::Error);
    });
...
void StrataServerTest::testBuildPlatformMessageApiV2()
{
    ...
    server.registerHandler(
        "platform_notification", [&server](const strata::strataComm::Message &message) {
            server.notifyClient(message, {{"key", "value"}, {"test", "test"}},
...
void StrataServerTest::testParsePlatformMessageAPIv1()
{
    ...
    server.registerHandler("platform_message", [&handlerCalled, &currentCommandName](
                                                   const strata::strataComm::Message &message) {
