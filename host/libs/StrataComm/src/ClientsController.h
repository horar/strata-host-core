...
public:
    ...
    void notifyAllClients(const QString &handlerName, const QJsonObject &payload); // maybe make this a slot?
...
signals:
    void notifyClientSignal(const Client &client, const QString &handlerName, const QJsonObject &payload);
