...
{
    qCDebug(logCategoryHcsStorage) << "Searching firmware " << version << " for" << classId << "and" << controllerClassId;
...
{
    qCDebug(logCategoryHcsStorage) << "Searching for highest firmware for " << classId << "and" << controllerClassId;
