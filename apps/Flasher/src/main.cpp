...
int main(int argc, char *argv[])
{
    ...
    qCDebug(lcFlasherCli) << QString(constants::LOGLINE_LENGTH, constants::LOGLINE_CHAR_MAJOR);
    ...
    qCDebug(lcFlasherCli) << QString(constants::LOGLINE_LENGTH, constants::LOGLINE_CHAR_MINOR);
