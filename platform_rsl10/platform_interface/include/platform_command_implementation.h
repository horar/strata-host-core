...
static const char *response_string[] = {
        ...
        "{\"notification\":\"payload\":{\"return_string\":\"error: payload not found\"}}",
...
enum emit_messages {
    BAD_JSON, COMMAND_NOT_FOUND, PAYLOAD_NOT_FOUND, COMMAND_VALID, LONG_COMMAND
};
...
#endif //PLATFORM_INTERFACE_INCLUDE_PLATFORM_COMMAND_IMPLEMENTATION_H
