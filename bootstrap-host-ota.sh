...
STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=${STRATA_HCS_CONFIG_FILE_QA}

if [ $USE_PROD_CONFIG != 0 ] ; then
    STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=${STRATA_HCS_CONFIG_FILE_PROD}
elif [ $USE_QA_CONFIG != 0 ] ; then
    STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=${STRATA_HCS_CONFIG_FILE_QA}
elif [ $USE_DEV_CONFIG != 0 ] ; then
    STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=${STRATA_HCS_CONFIG_FILE_DEV}
elif [ $USE_DOCKER_CONFIG != 0 ] ; then
    STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=${STRATA_HCS_CONFIG_FILE_DOCKER}
fi
