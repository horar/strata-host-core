...
set STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=%STRATA_HCS_CONFIG_FILE_QA%

if %USE_PROD_CONFIG% EQU 1 (
	set STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=%STRATA_HCS_CONFIG_FILE_PROD%
) else if %USE_QA_CONFIG% EQU 1 (
	set STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=%STRATA_HCS_CONFIG_FILE_QA%
) else if %USE_DEV_CONFIG% EQU 1 (
	set STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=%STRATA_HCS_CONFIG_FILE_DEV%
) else if %USE_DOCKER_CONFIG% EQU 1 (
	set STRATA_HCS_CONFIG_FILE=-DAPPS_CORESW_HCS_CONFIG:STRING=%STRATA_HCS_CONFIG_FILE_DOCKER%
)
