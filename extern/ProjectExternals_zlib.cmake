...
if(WIN32)
    ...
    set_target_properties(ZLIB::ZLIB PROPERTIES
        ...
        IMPORTED_LOCATION  "${EXTERN_INSTALL_DIR_PATH}/Zlib-${GIT_HASH}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}zlibstatic${CMAKE_STATIC_LIBRARY_SUFFIX}"
        IMPORTED_LOCATION_DEBUG  "${EXTERN_INSTALL_DIR_PATH}/Zlib-${GIT_HASH}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}zlibstaticd${CMAKE_STATIC_LIBRARY_SUFFIX}"
